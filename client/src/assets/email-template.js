export const attendanceCheckoutReminderTemplate = ({ employee, attendance }) => `
...
export const leaveApplicationReminderTemplate = ({ employee, leaveApplication }) => `
  <div style="max-width: 600px;">
    <h2>Hi Admin,</h2>
...
export const attendanceReminderTemplate = ({ employee }) => `
